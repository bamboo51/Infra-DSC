                                    ...
                                    <div className="group">
                                        <div className="bg-gray-50 rounded-2xl p-8 h-full border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                            <div className="flex items-center mb-6">
                                                ...
                                                <h3 className="text-xl font-semibold text-black">The Challenge</h3>
                                            </div>
                                    ...
                                    <div className="group">
                                        <div className="bg-gray-50 rounded-2xl p-8 h-full border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                            <div className="flex items-center mb-6">
                                                ...
                                                <h3 className="text-xl font-semibold text-black">Impact</h3>
                                            </div>
                                            <p className="text-gray-600 leading-relaxed">
                ...
                <section className="mb-20">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex items-center mb-12 justify-center">
                            ...
                            <h2 className="text-4xl font-bold text-black">Development History</h2>
                        </div>
                                    ...
                                    <div className="space-y-12">
                                            ...
                                            <div className="ml-20 group">
                                                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                                    <div className="flex items-center mb-4">
                                                        <span className="text-sm font-semibold text-white bg-black px-3 py-1 rounded-full mr-4">Phase 1</span>
                                                        <span className="text-gray-500">2024年 Q1-Q2</span>
                                                    </div>
                                                    <h3 className="text-xl font-bold text-black mb-3">プロジェクト立ち上げ・基盤研究</h3>
                                                    <ul className="text-gray-600 space-y-2">
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>インフラ点検の課題調査と要件定義</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>YOLO モデルの選定と基礎実験</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>データセット収集・整備開始</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-20 group">
                                                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                                    <div className="flex items-center mb-4">
                                                        <span className="text-sm font-semibold text-white bg-black px-3 py-1 rounded-full mr-4">Phase 2</span>
                                                        <span className="text-gray-500">2024年 Q3-Q4</span>
                                                    </div>
                                                    <h3 className="text-xl font-bold text-black mb-3">AI モデル開発・訓練</h3>
                                                    <ul className="text-gray-600 space-y-2">
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>クラック検出用YOLOモデルの訓練</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>セグメンテーションモデルの実装</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>モデル最適化とパフォーマンス改善</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-20 group">
                                                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                                    <div className="flex items-center mb-4">
                                                        <span className="text-sm font-semibold text-white bg-black px-3 py-1 rounded-full mr-4">Phase 3</span>
                                                        <span className="text-gray-500">2025年 Q1-Q2</span>
                                                    </div>
                                                    <h3 className="text-xl font-bold text-black mb-3">プラットフォーム開発</h3>
                                                    <ul className="text-gray-600 space-y-2">
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>Django REST Framework によるバックエンド構築</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>Next.js フロントエンド開発</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>リアルタイム解析機能の実装</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-20 group">
                                                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg">
                                                    <div className="flex items-center mb-4">
                                                        <span className="text-sm font-semibold text-white bg-black px-3 py-1 rounded-full mr-4">Phase 4</span>
                                                        <span className="text-gray-500">2025年 Q3 - 現在</span>
                                                        <span className="text-xs text-white bg-gray-600 px-2 py-1 rounded-full ml-2">進行中</span>
                                                    </div>
                                                    <h3 className="text-xl font-bold text-black mb-3">統合・テスト・改善</h3>
                                                    <ul className="text-gray-600 space-y-2">
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>システム統合とエンドツーエンドテスト</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>ユーザーインターフェース改善</li>
                                                        <li className="flex items-center"><span className="w-2 h-2 bg-black rounded-full mr-3"></span>パフォーマンス最適化とスケーラビリティ向上</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <section className="text-center mb-16">
                    <div className="max-w-4xl mx-auto relative">
                        <div className="relative bg-black rounded-3xl p-12 shadow-xl border border-gray-200">
                            ...
                            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-white">安全な道路を一緒に作ろう！</h3>
