          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <a 
                ...
                className="group p-2 bg-gray-900 rounded-xl hover:bg-white transition-all duration-300 transform hover:scale-110 border border-gray-800"
              >
                <svg
